function segm = mean_shift_segm(I, spatial_bandwidth,...
    colour_bandwidth, num_iterations, type)
...
L = 10;
if strcmpi('std',type)
    [ segm, centers ,~,~] = kmeans_segm(I, K, L, 'forgy',0,0,'img');
elseif strcmpi('opt',type)
    Nruns = 10 ;
    [ segm, centers ,~] = kmeans_opt(I, K, L, 'forgy', Nruns);
end
% toc
